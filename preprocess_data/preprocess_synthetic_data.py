...
OUT_IMG_ROOT = "/lustre/scratch/client/vinai/users/tungdt33/ARP/data/DATA_ARP/synthetic_images"
OUT_SEMANTIC_ROOT = "/lustre/scratch/client/vinai/users/tungdt33/ARP/data/DATA_ARP/synthetic_labels"

TRAIN_JSON_PATH = "/lustre/scratch/client/vinai/users/tungdt33/ARP/data/DATA_ARP/synthetic_train_data.json"
TEST_JSON_PATH = "/lustre/scratch/client/vinai/users/tungdt33/ARP/data/DATA_ARP/synthetic_test_data.json"
...
mask_fisheyes_carla_path = {"fisheye_front" : "/lustre/scratch/client/vinai/users/tungdt33/ARP/data/vehicle_mask/carlaSim/roi_mask_carlaSim_fisheye_front.png",
...
for key, value in mask_fisheyes_carla_path.items():
...
for bag_name in os.listdir(DATA_ROOT):
    ...
    for topic_name in list_extracted_topics:
        ...
        for image_name in os.listdir(image_dir):
            ...
            # update_label_road = cv2.fillPoly(label_road, road_cnts,  1) # 1 is the road class
            ...
            # label_img = INHOUSE_PALETTE[label]
            # masked_image =np.array( masked_image * 0.5 + label_img * 0.5, dtype=np.uint8)
            # img = Image.fromarray(masked_image)
            # new_image_path = os.path.join(OUT_IMG_ROOT, position + "_" + image_name)


            new_semantic_path = os.path.join(OUT_SEMANTIC_ROOT, bag_name + "_" + position + "_" + image_name.replace("jpeg", "npy"))
            ...
            data = {"tag" : bag_name,
                    "img_path" : image_path,
                    "semantic_path" : new_semantic_path,
                    "depth_path" : depth_path,
                    "normal_path" : normal_path,
                    "albedo_path" : albedo_path,
                    "mask" : mask_fisheyes_carla_path[topic_name],
                    "view" : position,
                    "type" : "synthetic",
                    }
